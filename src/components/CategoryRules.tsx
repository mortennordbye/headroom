...
// Lists the user's categorization rules (merchant/text → category) with a delete
// control. Rules are created from the transaction edit modal ("remember"); this
// is where they're reviewed and removed. Hidden entirely when there are none.
export function CategoryRules() {
  const { t, categoryRules, removeCategoryRule } = useFinance();
