...
export const translations = {
  nb: {
    ...
    budgetPage: {
      ...
      rememberRule: 'Husk denne kategorien for lignende',
      rememberRuleHint: 'Lager en regel som kategoriserer alle transaksjoner som inneholder teksten under (nå og senere).',
  ...
  en: {
    ...
    budgetPage: {
      ...
      rememberRule: 'Remember this category for similar',
      rememberRuleHint: 'Creates a rule that categorizes every transaction containing the text below (now and later).',
