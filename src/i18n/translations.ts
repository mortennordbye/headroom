...
export const translations = {
  nb: {
    ...
    expenseDestination: {
      ...
      hint: 'Hver måned flyttes dette beløpet hit: øker en sparekonto, eller nedbetaler boliglån/gjeld. Første flytting skjer neste måned.',
    ...
    expenseDialog: {
      ...
      noSavings: 'Du har ingen sparekontoer ennå. Legg til en under Formue.',
  ...
  en: {
    ...
    expenseDestination: {
      ...
      hint: 'Each month this amount moves here: grows a savings account, or pays down the mortgage/a debt. The first move happens next month.',
    ...
    expenseDialog: {
      ...
      noSavings: 'You have no savings accounts yet. Add one under Assets.',
