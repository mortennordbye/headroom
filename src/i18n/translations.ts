  ...
  nb: {
    ...
    settings: {
      ...
      bank: {
        ...
        historicalAccountsHint: 'Kontoer som finnes i transaksjonene dine, men ikke i en aktiv tilkobling (f.eks. etter ny tilkobling). Gi samme navn for å slå dem sammen.',
  ...
  en: {
    ...
    settings: {
      ...
      bank: {
        ...
        historicalAccountsHint: 'Accounts present in your transactions but not in a live connection (e.g. after re-linking). Give them the same name to merge them.',
